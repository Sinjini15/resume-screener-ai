...
def compute_resume_job_score(parsed_resume, job_description_text):
    ...
    if parsed_resume.get("skills"):
        resume_text_parts.append(" ".join(parsed_resume["skills"]))
    if parsed_resume.get("education"):
        resume_text_parts.append(" ".join(parsed_resume["education"]))
    if parsed_resume.get("experience"):
        resume_text_parts.append(" ".join(parsed_resume["experience"]))
